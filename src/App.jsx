...
function App() {
  useEffect(() => {
    // axes helper helps in  visualization of orinetation of body in 3D spaces 
    ...
    // rotate ground body by 90 degrees so the ground in horizontal
    ...
    // add base vehicle body in cannon
